...
public class KafkaConfig {
	@Value("${spring.kafka.bootstrap-servers:localhost:9902}")
	...
	@Bean
	public ConsumerFactory<String, Object> consumeFactory() {
	     ...
	     configProp.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.demo.events");
